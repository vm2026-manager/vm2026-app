...
|---|---:|
| missing_or_weak_round_context | 11 |
| likely_overweighted_by_model | 2 |
| uncertain_start | 2 |
| availability_risk | 1 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Scott McTominay | SCO | MID | likely_overweighted_by_model | 0.8738 | 3.1959 | Sammenlign marginal budgetbrug mod premium FWD-upside foer kalibrering. |
| Mahmoud Trezeguet | EGY | MID | missing_or_weak_round_context | 0.8438 | 1.2421 | Audit round EV og fixturefordeling foer eventuel modelkalibrering. |
| Jurrien Timber | NED | DEF | missing_or_weak_round_context | 0.6497 | 2.0551 | Audit round EV og fixturefordeling foer eventuel modelkalibrering. |
...
| Raphinha | BRA | FWD | missing_or_weak_round_context | 0.8812 | 2.2653 | Audit round EV og fixturefordeling foer eventuel modelkalibrering. |
| Deniz Undav | GER | FWD | missing_or_weak_round_context | 0.3287 | 2.096 | Audit round EV og fixturefordeling foer eventuel modelkalibrering. |
| Michael Olise | FRA | FWD | likely_underweighted_by_model | 0.7944 | 3.3065 | Brug positional budget-auditten foer eventuel senere modelaendring. |
...
| Cesar Montes | MEX | DEF | missing_or_weak_round_context | Reel eller delvis datamangel: aggregate/modelscore findes, men rundekonteksten er svag eller ikke i samme skala. |
...
| Nico Schlotterbeck | GER | DEF | missing_or_weak_round_context | Reel eller delvis datamangel: aggregate/modelscore findes, men rundekonteksten er svag eller ikke i samme skala. |
...
| Silvan Widmer | SUI | DEF | missing_or_weak_round_context | Reel eller delvis datamangel: aggregate/modelscore findes, men rundekonteksten er svag eller ikke i samme skala. |
...
| Fabian Rieder | SUI | MID | likely_overweighted_by_model | Mulig modelvaegtning: sikkerhed/value eller central MID/DEF-score kan fylde for meget. |
