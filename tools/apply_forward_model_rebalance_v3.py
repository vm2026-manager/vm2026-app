...
OVERRIDES = {
    ...
    "raul_jimenez__mex": {"mult": 0.66, "start": None, "note": "Valueangriber, men var stadig for låst i næste runde."},
    "marko_arnautovic__aut": {"mult": 0.72, "start": None, "note": "Valueangriber, men bør fylde mindre."},
    "nico_williams__esp": {"mult": 0.55, "start": 0.56, "note": "Skades-/startusikkerhed; skal ikke være long-run-lock."},
    "vinicius_junior__bra": {"mult": 0.96, "start": None, "note": "Stadig stærk long-run, men ikke for dominerende."},

    # Op: topangribere, men ikke som nye 7/7-locks
    ...
    "kylian_mbappe__fra": {"mult": 2.10, "start": None, "note": "Skal ind som reel premium/long-run-kandidat."},
    "michael_olise__fra": {"mult": 1.95, "start": None, "note": "Skal kunne konkurrere som Frankrig-angriber."},
    "ousmane_dembele__fra": {"mult": 2.15, "start": 0.74, "note": "Hævet start og EV; skal frem som alternativ."},
...
def apply_to_row(row, source):
    ...
    row["forward_model_rebalance_version"] = "v3"
...
print("Forward rebalance v3 applied")
